...
const { skillFilesEndpoints } = require("./endpoints/skillFiles");
const {
  customLlmProvidersEndpoints,
} = require("./endpoints/customLlmProviders");
...
skillFilesEndpoints(apiRouter);
customLlmProvidersEndpoints(apiRouter);
